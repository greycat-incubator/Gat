...
public class BitSet {
    ...
    public BitSetIterator iterator() {
        return new BitSetIterator(this, 0, false);
    }

    public BitSetIterator iterator(int fromElement) {
        return new BitSetIterator(this, fromElement, false);
    }


    public BitSetIterator descendingIterator(int fromElement) {
        return new BitSetIterator(this, fromElement, true);
    }


    public BitSetIterator descendingIterator() {
        return new BitSetIterator(this, this.length() - 1, true);
    }
}